...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(69, 41);
			...
			this->label3->Location = System::Drawing::Point(69, 124);
			...
			this->label4->Location = System::Drawing::Point(69, 164);
			...
			this->label5->Location = System::Drawing::Point(69, 203);
			...
			this->label6->Location = System::Drawing::Point(69, 246);
			...
			// btnPlaceAdd
			// 
			this->btnPlaceAdd->Location = System::Drawing::Point(413, 60);
			this->btnPlaceAdd->Name = L"btnPlaceAdd";
			this->btnPlaceAdd->Size = System::Drawing::Size(107, 23);
			...
			// btnPlaceUpdate
			// 
			this->btnPlaceUpdate->Location = System::Drawing::Point(413, 117);
			this->btnPlaceUpdate->Name = L"btnPlaceUpdate";
			this->btnPlaceUpdate->Size = System::Drawing::Size(111, 23);
			...
			// btnPlaceDelete
			// 
			this->btnPlaceDelete->Location = System::Drawing::Point(413, 186);
			this->btnPlaceDelete->Name = L"btnPlaceDelete";
			this->btnPlaceDelete->Size = System::Drawing::Size(119, 23);
			...
			// txtPlaceId
			// 
			this->txtPlaceId->Location = System::Drawing::Point(192, 38);
			this->txtPlaceId->Name = L"txtPlaceId";
			this->txtPlaceId->Size = System::Drawing::Size(100, 22);
			...
			// 
			this->txtPlaceAvailability->Location = System::Drawing::Point(192, 81);
			this->txtPlaceAvailability->Name = L"txtPlaceAvailability";
			this->txtPlaceAvailability->Size = System::Drawing::Size(100, 22);
			this->txtPlaceAvailability->TabIndex = 10;
			// 
			// txtPlacePowerOutlet
			// 
			this->txtPlacePowerOutlet->Location = System::Drawing::Point(192, 164);
			this->txtPlacePowerOutlet->Name = L"txtPlacePowerOutlet";
			this->txtPlacePowerOutlet->Size = System::Drawing::Size(100, 22);
			this->txtPlacePowerOutlet->TabIndex = 12;
			// 
			// txtPlaceParticipants
			// 
			this->txtPlaceParticipants->Location = System::Drawing::Point(192, 121);
			this->txtPlaceParticipants->Name = L"txtPlaceParticipants";
			this->txtPlaceParticipants->Size = System::Drawing::Size(100, 22);
			this->txtPlaceParticipants->TabIndex = 11;
			// 
			// txtPlaceLocation
			// 
			this->txtPlaceLocation->Location = System::Drawing::Point(192, 243);
			this->txtPlaceLocation->Name = L"txtPlaceLocation";
			this->txtPlaceLocation->Size = System::Drawing::Size(100, 22);
			this->txtPlaceLocation->TabIndex = 14;
			// 
			// txtPlaceTypePlace
			// 
			this->txtPlaceTypePlace->Location = System::Drawing::Point(192, 200);
			this->txtPlaceTypePlace->Name = L"txtPlaceTypePlace";
			this->txtPlaceTypePlace->Size = System::Drawing::Size(100, 22);
			...
			this->dgvPlace->Location = System::Drawing::Point(12, 306);
			this->dgvPlace->Name = L"dgvPlace";
			this->dgvPlace->RowHeadersWidth = 51;
			this->dgvPlace->RowTemplate->Height = 24;
			this->dgvPlace->Size = System::Drawing::Size(549, 241);
			...
			this->ClientSize = System::Drawing::Size(576, 559);
...
private: System::Void dgvPlace_CellContentClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	...
	int productId = Convert::ToInt32(dgvPlace->Rows[selectedRowIndex]->Cells[0]->Value->ToString());
	Place^ p = Controller::QueryPlaceById(productId);
