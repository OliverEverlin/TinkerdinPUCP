...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// txtCourseId
			// 
			this->txtCourseId->Location = System::Drawing::Point(219, 49);
			this->txtCourseId->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->labelCourseParfcialExam->Location = System::Drawing::Point(101, 303);
			...
			this->dateTimePickerParcial->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			// txtCourseName
			// 
			this->txtCourseName->Location = System::Drawing::Point(219, 86);
			this->txtCourseName->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->labelCourseFinalExam->Location = System::Drawing::Point(523, 300);
			...
			this->labelCourseExamDates->Location = System::Drawing::Point(67, 250);
			...
			this->txtCourseProfesor->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->labelCourseType->Location = System::Drawing::Point(67, 143);
			...
			this->dateTimePickerFinal->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->labelCourseProfessor->Location = System::Drawing::Point(67, 194);
			...
			this->cmbCourseType->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->labelCourseName->Location = System::Drawing::Point(67, 89);
			...
			this->btnUpdateCourse->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->labelCourse->Location = System::Drawing::Point(67, 52);
			...
			this->btnDeleteCourse->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->btn_AddCourse->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->dgvCourse->Location = System::Drawing::Point(821, 49);
			this->dgvCourse->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			...
			this->ClientSize = System::Drawing::Size(1515, 468);
...
#pragma endregion
	...
	private: System::Void btnAddCourse_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			...
			course->Status = 'A';
			course->StudentsList = gcnew List<String^>();
			//falta añadir cursos
